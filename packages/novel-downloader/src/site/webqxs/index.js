...
let NovelSiteWebqxs = class NovelSiteWebqxs extends base_1.default {
    makeUrl(urlobj, bool, optionsRuntime) {
        let url;
        if ((0, util_1.isUndef)(urlobj.novel_pid) || bool < 0) {
    ...
    createMainUrl(url, optionsRuntime) {
        ...
        if (!data || (0, util_1.isUndef)(data.novel_pid) || !data.novel_id) {
            console.log(data);
    ...
    _parseChapter(ret, optionsRuntime, cache) {
        ...
        try {
            let html = (0, util_1.minifyHTML)(ret.dom.$('#articlecontent').html());
